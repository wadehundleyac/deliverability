...
import co.acoustic.AccountingRecords;
...
public class log_processing implements AccountingProcessor {
    ...
    public void endRecord()
    {
        ...
        /* UNDELETE THIS ONCE WE HAVE SPCORE AVAILABLE
    ...
    public static void main(String args[]) {
        if (args.length < 2) {
            System.out.println("Expected arguments: path to accounting " +
                    "file and path to output directory");
            return;
        }
